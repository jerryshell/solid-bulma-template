...
const BookUpdate = () => {
  ...
  createEffect(() => {
    setTitle("TensorFlow For Machine Intelligence");
    setPrice(22.99);
    setPages(270);
    setIsbn("9781939902351");
    setCoverImage("https://placehold.co/160x210");
  });
  ...
  return (
    <>
      <nav class="breadcrumb">
        <ul>
          <li>
            <a onClick={() => setRoute("Books")}>Books</a>
          </li>
          <li class="is-active">
            <a>Edit Book</a>
          </li>
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        ...
        <div class="field">
          <div class="buttons">
            ...
            <button class="button is-medium is-light" onClick={() => setRoute("Books")}>
              Cancel
            </button>
          </div>
        </div>

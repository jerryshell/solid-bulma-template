    ...
    <>
      <nav class="level">
        <div class="level-left">
          ...
          <p class="level-item">
            <a class="button is-success" onClick={() => setRoute("BookCreate")}>
              New
            </a>
          </p>
...
const BookItem = (props: { name: string; price: number; pages: number; isbn: string }) => {
  return (
    <>
      <article class="box">
        <div class="media">
          ...
          <div class="media-content">
            ...
            <div class="content is-small">
              ...
              <br />
              <div class="buttons">
                <a class="button is-small" onClick={() => setRoute("BookUpdate")}>
                  Edit
                </a>
          ...
          {(item) => (
            <>
              <div class="column is-12-tablet is-6-desktop is-4-widescreen">
                <BookItem name={item.name} price={item.price} pages={item.pages} isbn={item.isbn} />
              </div>
            </>
          )}
        </For>

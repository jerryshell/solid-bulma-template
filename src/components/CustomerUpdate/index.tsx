...
const CustomerUpdate = () => {
  ...
  createEffect(() => {
    setFullName("John Miller");
    setEmail("johnmiller@example.com");
    setAddress1("55 Longbridge Road");
    setAddress2("");
    setPostcode("78170");
    setCity("Los Angeles");
  ...
  return (
    <>
      <nav class="breadcrumb">
        <ul>
          <li>
            <a onClick={() => setRoute("Customers")}>Customers</a>
          </li>
          <li class="is-active">
            <a>Edit Customer</a>
          </li>
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        ...
        <div class="columns is-desktop">
          ...
          <div class="column">
            ...
            <div class="control">
              <div class="select">
                <select value={country()} onInput={(e) => setCountry(e.currentTarget.value)}>
        ...
        <div class="field">
          <div class="buttons">
            <button class="button is-medium is-success" onClick={submit}>
              Save
            </button>
            <button class="button is-medium is-light" onClick={() => setRoute("Customers")}>
              Cancel
            </button>
          </div>
        </div>

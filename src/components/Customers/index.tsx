    ...
    <>
      <nav class="level">
        <div class="level-left">
          ...
          <p class="level-item">
            <a class="button is-success" onClick={() => setRoute("CustomerCreate")}>
              New
            </a>
          </p>
...
const CustomerItem = (props: { name: string; email: string; country: string; orders: number }) => {
  return (
    <>
      <tr>
        <td>
        ...
        <td>
          <a onClick={() => setRoute("CustomerUpdate")}>
        ...
        <td>
          <div class="buttons">
            <a class="button is-small" onClick={() => setRoute("CustomerUpdate")}>
              Edit
            </a>

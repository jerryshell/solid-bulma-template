    ...
    <>
      <nav class="navbar has-shadow">
        <div class="navbar-brand">
          ...
          <div class="navbar-burger" onClick={() => setActiveNavbarMenu(!activeNavbarMenu())}>
            <span></span>
            <span></span>
            <span></span>
            <span></span>
          ...
          <div class="navbar-end">
            <div class="navbar-item has-dropdown is-hoverable">
              ...
              <div class="navbar-dropdown">
                ...
                <a class="navbar-item" onClick={() => setTheme("")}>
                  <span class="icon">
            ...
            <div class="navbar-item has-dropdown is-hoverable">
              <div class="navbar-link">Admin Jerry</div>
              <div class="navbar-dropdown">
                <a class="navbar-item" onClick={() => setActiveReportBug(true)}>
                  <span class="icon">
                    <i class="fa fa-bug"></i>
                  </span>
                  Report Bug
                </a>
                <a class="navbar-item" onClick={() => setRoute("Login")}>
                  <span class="icon">
      ...
      <div class="modal" classList={{ "is-active": activeReportBug() }}>
        <div class="modal-background" onClick={() => setActiveReportBug(false)}></div>
        <div class="modal-card">
          <header class="modal-card-head">
            <p class="modal-card-title">Report Bug</p>
            <button class="delete" onClick={() => setActiveReportBug(false)}></button>
          </header>
          ...
          <footer class="modal-card-foot">
            <div class="buttons">
              ...
              <button class="button" onClick={() => setActiveReportBug(false)}>
                Cancel
              </button>
            </div>
          </footer>
